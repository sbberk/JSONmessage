...
__author__ = "Sean Brennan"
__copyright__ = "Copyright 2013"
__credits__ = ["Sean Brennan"]
__license__ = "CC"
__version__ = "1.0"
__maintainer__ = "Sean Brennan"
__email__ = "seanwbren@gmail.com"

if len(sys.argv) <= 1:
	print "Usage:\n 	python message.py [conversation ID] [chunk_size (recommended: 2000)] [{optional} offset location (default: 0)]"
	print "Example conversation with Sean Brennan"
	print "	python message.py 1075686392 2000 0"
	sys.exit()
